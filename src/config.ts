...
export const siteConfig: SiteConfig = {
	title: "Alan's Blog",
	subtitle: "枕石待云归",
	siteURL: "https://blog.41an.com/", // 请替换为你的站点URL，以斜杠结尾
	...
	banner: {
		...
		src: {
			desktop: ["/assets/desktop-banner/map-1.jpg"], // 桌面横幅图片
			mobile: ["/assets/mobile-banner/sea-1.jpg"], // 移动横幅图片
		}, // 使用本地横幅图片
		...
		homeText: {
			...
			title: "Alan's Blog", // 主页横幅主标题
			subtitle: ["Recording my growth in cybersecurity."],
			typewriter: {
	...
	font: {
		...
		cjkFont: {
			// 中日韩字体 - 作为回退字体
			fontFamily: "jf-openhuninn-2.1",
			fontWeight: "500",
			localFonts: ["jf-openhuninn-2.1.ttf"],
			enableCompress: true, // 启用字体子集优化，减少字体文件大小
		},
	},
...
export const umamiConfig = {
	...
	scripts: `
<script defer src="https://cloud.umami.is/script.js" data-website-id="c1067bbb-febf-4238-8c31-046135ed6804"></script>
